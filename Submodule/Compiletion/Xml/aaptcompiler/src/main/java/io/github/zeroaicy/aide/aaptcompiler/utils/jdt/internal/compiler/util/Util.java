 ...
 *
 **************************************************************************************/
package io.github.zeroaicy.aide.aaptcompiler.utils.jdt.internal.compiler.util;
...
public class Util {
     ...
     * @param start  the 0-based character index of the first character
     * @return the 0-based character index of the last character
     * @throws IllegalArgumentException if this is not a base type signature
     */
     ...
     * @param start  the 0-based character index of the first character
     * @return the 0-based character index of the last character
     * @throws IllegalArgumentException if this is not a capture type signature
     */
     ...
     * @param start  the 0-based character index of the first character
     * @return the 0-based character index of the last character
     * @throws IllegalArgumentException if this is not a type variable signature
     */
     ...
     * @param start  the 0-based character index of the first character
     * @return the 0-based character index of the last character
     * @throws IllegalArgumentException if this is not an identifier
     */
     ...
     * @param start  the 0-based character index of the first character
     * @return the 0-based character index of the last character
     * @throws IllegalArgumentException if this is not a list of type arguments signatures
     */
