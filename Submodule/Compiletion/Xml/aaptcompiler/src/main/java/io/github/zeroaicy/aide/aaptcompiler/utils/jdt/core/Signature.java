 ...
 *******************************************************************************/
package io.github.zeroaicy.aide.aaptcompiler.utils.jdt.core;


import java.util.ArrayList;

import io.github.zeroaicy.aide.aaptcompiler.utils.jdt.core.compiler.CharOperation;
import io.github.zeroaicy.aide.aaptcompiler.utils.jdt.internal.compiler.parser.ScannerHelper;
import io.github.zeroaicy.aide.aaptcompiler.utils.jdt.internal.compiler.util.Util;
...
public final class Signature {
    ...
    public static String getQualifier(String name) {
        ...
        if (qualifier.length == 0) return Util.EMPTY_STRING;
     ...
     * @throws NullPointerException if <code>methodOrTypeSignature</code> is null
     * @since 3.1
     */
     ...
     * @throws IllegalArgumentException if this is not an array type signature
     ...
     * @return the 0-based character index of the last character
     * @throws IllegalArgumentException if this is not a class type signature
     ...
     * @param buffer                the string buffer to append to
     * @return the 0-based character index of the last character
     * @throws IllegalArgumentException if this is not a type argument signature
     ...
     * @param buffer                the string buffer to append to
     * @return the 0-based character index of the last character
     * @throws IllegalArgumentException if this is not a list of type argument signatures
     ...
     * @return the 0-based character index of the last character
     * @throws IllegalArgumentException if this is not a type signature, or if isVarArgs is <code>
