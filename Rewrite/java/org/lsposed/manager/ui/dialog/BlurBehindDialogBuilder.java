...
public class BlurBehindDialogBuilder extends MaterialAlertDialogBuilder {
    ...
    private static final String TAG = "BlurBehindDialogBuilder";
                ...
                try {
                    ...
                    animator.addUpdateListener(animation -> {
                        try {
                            ...
                            Log.e(TAG, "Blur behind dialog builder", t);
                        }
                    });
                } catch (Throwable t) {
                    Log.e(TAG, "Blur behind dialog builder", t);
    ...
    public static boolean getSystemProperty(String key, boolean defaultValue) {
        ...
        try {
            ...
            Log.e(TAG, "Blur behind dialog builder get system property", e);
        }
        return value;
    }
}
